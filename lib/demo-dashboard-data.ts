...
export const demoMissedCallRecoveryRows: DashboardCallRow[] = [
  createDemoRow({
    id: "missed-call-adam-spencer",
    caller: "Adam Spencer",
    time: "Today",
    issue: "Missed call recovery queue",
    reason: "No callback made",
    recommendedAction: "Call immediately and secure the booking window before the lead goes cold.",
    status: "Action Required",
    workflowStatusLabel: "Action Required",
    actionStatus: "Needs Action",
    statusTone: "critical",
    urgency: "Critical Priority",
    urgencyTone: "critical",
    assignedOwner: "A. Howard",
    dueBy: "Today • 15:30",
    responseDelayHours: 4.8,
    revenue: "£420",
    revenueValue: 420,
    noteTop: "No callback made -",
    noteBottom: "urgent recovery required",
    category: "delayed-response",
    periodByRange: { "7d": "Wed", "30d": "W5", "90d": "Apr" },
    phone: "+44 7700 900201",
    date: "April 2, 2026 • 9:14 AM",
    summary:
      "Adam called during the morning booking window with a clear service need, but the enquiry was not routed into an outbound callback workflow.",
    nextStep: "Call immediately",
    notes: [
      "No callback was logged after the inbound service enquiry.",
      "Lead indicated urgency and expected same-day contact."
    ],
    analysisPending: false,
    analysisStatus: "completed",
    intentLevel: "High",
    ...
    revenueImpact: "£420",
    revenueImpactValue: 420,
    analystNote: "Clear inbound demand with no recorded follow-up.",
    conciseAnalystNote: "High-intent call with no callback action.",
    startedAtRaw: "2026-04-02T09:14:00Z",
    updatedAtRaw: "2026-04-02T11:32:00Z",
    externalId: "ORV-MISSED-001",
    direction: "inbound",
    recordingFilename: "2026-04-02_adam-spencer_missed.wav",
    sourceSystem: "Twilio"
  }),
  createDemoRow({
    id: "missed-call-emily-green",
    caller: "Emily Green",
    time: "Today",
    issue: "Missed call recovery queue",
    reason: "Follow-up sent, awaiting reply",
    recommendedAction: "Confirm availability and resend the booking link before end of day.",
    status: "Under Review",
    ...
    assignedOwner: "J. Mercer",
    dueBy: "Today • 17:15",
    responseDelayHours: 2.2,
    revenue: "£260",
    revenueValue: 260,
    noteTop: "Follow-up sent -",
    noteBottom: "response still pending",
    category: "delayed-response",
    periodByRange: { "7d": "Wed", "30d": "W5", "90d": "Apr" },
    phone: "+44 7700 900202",
    date: "April 2, 2026 • 10:37 AM",
    summary:
      "Emily’s missed inbound call was followed up, but the customer has not yet confirmed the appointment and the recovery path is still open.",
    nextStep: "Confirm availability and resend booking link",
    notes: [
      "Outbound follow-up sent via SMS and email.",
      "Waiting for customer confirmation before closing the recovery case."
    ],
    analysisPending: false,
    analysisStatus: "completed",
    intentLevel: "Medium",
    ...
    missedOpportunityLabel: "Yes",
    missedOpportunityDetected: true,
    primaryIssue: "Follow-up sent, awaiting reply",
    revenueImpact: "£260",
    revenueImpactValue: 260,
    analystNote: "Recovery workflow started, but confirmation has not yet been secured.",
    conciseAnalystNote: "Follow-up sent; customer response pending.",
    startedAtRaw: "2026-04-02T10:37:00Z",
    updatedAtRaw: "2026-04-02T12:05:00Z",
    externalId: "ORV-MISSED-002",
    direction: "inbound",
    recordingFilename: "2026-04-02_emily-green_missed.wav",
    sourceSystem: "Aircall"
  }),
  createDemoRow({
    id: "missed-call-brian-thompson",
    caller: "Brian Thompson",
    time: "Today",
    issue: "Missed call recovery queue",
    reason: "Escalated after high-value missed enquiry",
    recommendedAction: "Manager call-back within the hour to recover the high-value opportunity.",
    status: "Escalated",
    ...
    assignedOwner: "S. Patel",
    dueBy: "Today • 14:15",
    responseDelayHours: 5.1,
    revenue: "£610",
    revenueValue: 610,
    noteTop: "High-value missed enquiry -",
    noteBottom: "management escalation",
    category: "missed-booking",
    periodByRange: { "7d": "Wed", "30d": "W5", "90d": "Apr" },
    phone: "+44 7700 900203",
    date: "April 2, 2026 • 11:06 AM",
    summary:
      "Brian’s enquiry carried strong commercial value, but the inbound call was mishandled and has now been escalated for senior follow-up.",
    nextStep: "Escalate to manager and call back",
    notes: [
      "High purchase intent detected in the initial enquiry.",
      "Case escalated after missed booking opportunity exceeded standard queue threshold."
    ],
    analysisPending: false,
    analysisStatus: "completed",
    intentLevel: "High",
    ...
    missedOpportunityLabel: "Yes",
    missedOpportunityDetected: true,
    primaryIssue: "Escalated after high-value missed enquiry",
    revenueImpact: "£610",
    revenueImpactValue: 610,
    analystNote: "High-value missed opportunity now requires management recovery.",
    conciseAnalystNote: "Escalated after high-value missed booking signal.",
    startedAtRaw: "2026-04-02T11:06:00Z",
    updatedAtRaw: "2026-04-02T12:44:00Z",
    externalId: "ORV-MISSED-003",
    direction: "inbound",
    recordingFilename: "2026-04-02_brian-thompson_missed.wav",
    sourceSystem: "RingCentral"
  }),
  createDemoRow({
    id: "missed-call-laura-bennett",
    caller: "Laura Bennett",
    time: "Today",
    issue: "Missed call recovery queue",
    reason: "Callback completed and case closed",
    ...
    revenue: "£340",
    revenueValue: 340,
    noteTop: "Recovery completed -",
    noteBottom: "case closed",
    category: "delayed-response",
    periodByRange: { "7d": "Wed", "30d": "W5", "90d": "Apr" },
    phone: "+44 7700 900204",
    date: "April 2, 2026 • 12:24 PM",
    summary:
      "Laura’s missed call was successfully recovered with a completed callback and confirmed next step, so the recovery case is now closed.",
    nextStep: "Closed after successful recovery",
    notes: [
      "Outbound callback completed successfully.",
      "Customer confirmed booking and recovery workflow has been closed."
    ],
    analysisPending: false,
    analysisStatus: "completed",
    intentLevel: "Medium",
    ...
    missedOpportunityLabel: "No",
    missedOpportunityDetected: false,
    primaryIssue: "Callback completed and case closed",
    revenueImpact: "£340",
    revenueImpactValue: 340,
    analystNote: "Opportunity successfully recovered through outbound follow-up.",
    conciseAnalystNote: "Recovered and closed after callback.",
    startedAtRaw: "2026-04-02T12:24:00Z",
    updatedAtRaw: "2026-04-02T13:10:00Z",
    externalId: "ORV-MISSED-004",
    direction: "inbound",
    recordingFilename: "2026-04-02_laura-bennett_missed.wav",
    sourceSystem: "Twilio"
  })
];
...
export function getDemoCallRecordView(id: string): { row: DashboardCallRow; detail: CallRecordDetail } | null {
  const row = [...demoDashboardRows, ...demoMissedCallRecoveryRows].find((entry) => entry.id === id);
